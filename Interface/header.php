    ...
    <h1 class='titre_projet'>Géstion de colis coopérative</h1>
      <nav>
        <ul class="nav_menu">
          ...
          <li><a id="navbar" href="Interface/Voiture/interface_Voiture">Voiture</a></li>
          <li><a id="navbar" href="Interface/Envoyer/interface_Envoyer.php">Envoyer</a></li>
          <li><a id="navbar" href="Interface/Recevoir/interface_Recevoir.php">Recevoir</a></li>
        </ul>
      </nav>
